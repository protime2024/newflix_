    ...
    <section class="pt-80 pb-80">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <form action="https://newflix.net/payment/fib/payment.php" method="post" class="deposit-form">
                        @csrf
                                ...
                                <div class="col-lg-6">
                                    <div class="payment-system-list p-3">
                                        ...
                                        <div class="deposit-info total-amount pt-3">
                                            <div class="deposit-info__title">
                                                <p style="font-size:larger!important" class="text">@lang('Total')</p>
                                            </div>
                                            <div class="deposit-info__input">
                                                <p style="font-size:larger!important" class="text"><span class="final-amount">@lang('0.00')</span>
                                                    {{ __(gs('cur_text')) }}</p>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        (function($) {
            ...
            function calculation() {
                ...
                $(".final-amount").text(totalAmount.toFixed(0));
