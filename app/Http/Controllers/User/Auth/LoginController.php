...
class LoginController extends Controller
{
    ...
    // Override the attemptLogin method to check both username and email
    protected function attemptLogin(Request $request)
    {
        $login = $request->input('username');
        
        // Try to authenticate with the provided credential as username
        $usernameCredentials = ['username' => $login, 'password' => $request->input('password')];
        if (Auth::attempt($usernameCredentials, $request->filled('remember'))) {
            return true;
        }
        
        // If username authentication fails, try with email
        $emailCredentials = ['email' => $login, 'password' => $request->input('password')];
        return Auth::attempt($emailCredentials, $request->filled('remember'));
    }
    ...
    public function authenticated(Request $request, $user)
    {
        ...
        return $redirection ? $redirection : redirect('/');
    }
}